...
a4_bg_image_path = get_asset_path("a4_stand_bg.jpg")  # 🚨 [NEW] A4 Composite Frame ပုံလမ်းကြောင်း
...
if qr_strings_list:
    ...
    def build_4x6_stand_html(qr_base64, shop_name):
        ...
        clean_bg = str(FRAME_BACKGROUND).replace("\n", "").replace("\r", "").strip() if FRAME_BACKGROUND else ""
        return f"""
        <div class="mmqr-print-frame" style="width: 384px; height: 576px; position: relative; overflow: hidden; box-sizing: border-box; margin: 0 auto; page-break-after: always; background: white;">
            <img src="data:image/png;base64,{clean_bg}" style="position: absolute; top: 0; left: 0; width: 384px; height: 576px; z-index: 1; object-fit: fill; display: block;"/>
    ...
    # ၂။ အသစ်ပေးပို့ထားသော a4_stand_bg.jpg ပေါ်တွင် ၃ ဆိုင် ကွက်တိနေရာချမည့် Composite Function
    def build_a4_composite_html(chunk_data):
        global A4_FRAME_BACKGROUND
        # Base64 စာသားအတွင်းရှိ ကွဲအက်နေသော လိုင်းကူးများကို လုံးဝ သန့်စင်ပစ်ခြင်း
        ...
        <div style="position: absolute; top: 0; left: 0; width: 560px; height: 840px; z-index: 2;">
            <div style="position: absolute; top: 190px; left: 114px; width: 318px; height: 318px; display: flex; align-items: center; justify-content: center; overflow: hidden;">
                <img src="data:image/png;base64,{p1_qr}" style="width: 98%; height: 98%; object-fit: contain;"/>
            </div>
            <div style="position: absolute; top: 624px; left: 0; width: 100%; text-align: center;">
                <span style="font-family: 'MyanmarAngoun', sans-serif; font-size: 26px; font-weight: bold; color: #FFB300; text-transform: uppercase; display: inline-block; width: 90%; letter-spacing: 0.5px;">{p1_name}</span>
            </div>
        </div>
        """ if p1_qr else ""
        ...
        <div style="position: absolute; top: 0; left: 560px; width: 560px; height: 840px; z-index: 2;">
            <div style="position: absolute; top: 190px; left: 114px; width: 318px; height: 318px; display: flex; align-items: center; justify-content: center; overflow: hidden;">
                <img src="data:image/png;base64,{p2_qr}" style="width: 98%; height: 98%; object-fit: contain;"/>
            </div>
            <div style="position: absolute; top: 624px; left: 0; width: 100%; text-align: center;">
                <span style="font-family: 'MyanmarAngoun', sans-serif; font-size: 26px; font-weight: bold; color: #FFB300; text-transform: uppercase; display: inline-block; width: 90%; letter-spacing: 0.5px;">{p2_name}</span>
            </div>
        </div>
        """ if p2_qr else ""

        # ဆိုင် ၃ (အောက်ခြေ ကန့်လန့်ဖြတ်)
        l3_html = f"""
        <div style="position: absolute; top: 840px; left: 0; width: 1120px; height: 744px; display: flex; align-items: center; justify-content: center; z-index: 2;">
            <div style="width: 560px; height: 840px; transform: rotate(-90deg); transform-origin: center; position: relative; flex-shrink: 0;">
                <div style="position: absolute; top: 190px; left: 114px; width: 318px; height: 318px; display: flex; align-items: center; justify-content: center; overflow: hidden;">
                    <img src="data:image/png;base64,{l3_qr}" style="width: 98%; height: 98%; object-fit: contain;"/>
                </div>
                <div style="position: absolute; top: 624px; left: 0; width: 100%; text-align: center;">
                    <span style="font-family: 'MyanmarAngoun', sans-serif; font-size: 26px; font-weight: bold; color: #FFB300; text-transform: uppercase; display: inline-block; width: 90%; letter-spacing: 0.5px;">{l3_name}</span>
                </div>
            </div>
        </div>
        """ if l3_qr else ""
        ...
        <div class="a4-page-box" style="width: 1120px; height: 1584px; position: relative; overflow: hidden; box-sizing: border-box; page-break-after: always; background: white;">
            <img src="data:image/jpeg;base64,{clean_a4_bg}" style="position: absolute; top: 0; left: 0; width: 1120px; height: 1584px; z-index: 1; object-fit: fill; display: block;"/>
            {p1_html}
            {p2_html}
            {l3_html}
        </div>
